...
Let X={0,1,2,3....15} be the random variable,where X represents the number of defective parts.The distribution is binomial.
\begin{align}
    \tag{1}
    p=0.05\\
    \tag{2}
...
From (1) and (2)
\begin{multline}
\Pr(X>1) = 1-{\comb{15}  {0}} \times (0.05)^{0}\times (0.95)^{15} \\-{\comb{15}  {1}}\times (0.05)^{1} \times (0.95)^{14} =0.179 
\end{multline}
\begin{align}
